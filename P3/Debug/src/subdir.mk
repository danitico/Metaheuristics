...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/daniel/Desktop/TERCERO_CARRERA/Metaheuristics/P3/src/include" -O3 -g3 -pedantic -pedantic-errors -Wall -Wextra -Wconversion -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
